...
% \thesistitle{Leveraging a neural network's feature-representation for inverse problems}
\thesistitle{Leveraging a Neural Network’s Feature-Representation for Deep Domain-Adaptation}
